...
The above format signifies that there are 5 scenes where Anthony and Michael have both appeared together in the movie Godfather (as annotated in the dataset we are using)
---
